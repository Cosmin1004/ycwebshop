...
public class CategoryUtil {
    ...
    private final static String [] clothingAndShoes = { "CLOTHING_AND_SHOES",  "clothes", "shoes", "fashion" };
    ...
    private final static String [] healtyAndBeauty = { "HEALTH_AND_BEAUTY", "cream", "parfume", "healty", "beauty" };
    private final static String [] homeAndGarden = { "HOME_AND_GARDEN", "table", "flowers", "furniture", "home", "garden" };
